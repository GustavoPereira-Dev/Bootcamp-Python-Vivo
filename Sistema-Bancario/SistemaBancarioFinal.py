...
class Cliente:
    ...
    def realizar_transacao(self, conta, transacao):
        if len(conta.historico.transacoes_diarias()) >= 2:
            print("O limite de transações diárias foi excedida!")
            return
...
def criar_cliente(clientes):
    ...
    data_nascimento = input("Informe a data de nascimento do usuário de acordo com o formato (dd-mm-aaaa): ")
